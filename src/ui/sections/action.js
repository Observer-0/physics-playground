  ...
  const ACTION = {
    ...
    body: {
      ...
      en: () =>
        ...
        '<h3 class="th-h3">Why R of all things?</h3>' +
        ...
        '<h3 class="th-h3">Dimensional analysis: the Planck length is waiting here</h3>' +
  ...
  const HISTORY = {
    ...
    body: {
      de: () =>
        ...
        '<h3 class="th-h3">Zeitleiste</h3>' + timeline() +
      ...
      en: () =>
        ...
        '<h3 class="th-h3">Timeline</h3>' + timeline() +
